...
<div class="form-container">
    <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="form-input @error('name') is-invalid @enderror" value="{{ old('name', $category->name) }}" required placeholder="Nhập tên danh mục">
            @error('name')
        ...
        <div class="form-group">
            ...
            <textarea id="description" name="description" class="form-input" rows="4" placeholder="Mô tả danh mục">{{ old('description', $category->description) }}</textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="image-upload-wrapper">
                <div class="image-preview" id="iconPreview" onclick="document.getElementById('icon').click()">
                    @if($category->icon)
                        <img src="{{ $category->icon }}" alt="Icon" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;">
                    @else
