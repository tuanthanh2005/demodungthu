...
window.showCategoriesPage = loadCategoriesPage;
...
console.log('Category admin functions exposed to window:', {
    showCategoriesPage: typeof window.showCategoriesPage,
    showAddCategoryModal: typeof window.showAddCategoryModal
});
...
function renderCategoriesTable() {
    ...
    if (!tbody) {
        console.error('Element categoriesTable not found!');
        return;
    }
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <button class="btn btn-sm btn-secondary" onclick="showEditCategoryModal(${category.id})" title="Sửa">✏️</button>
                        <button class="btn btn-sm btn-danger" onclick="deleteCategory(${category.id})" title="Xóa">🗑️</button>
                    </div>
                </td>
            </tr>
        `;
